      ...
      <div class="adoption-tips">
        ...
        <ul class="adoption-tips-list">
          <li class="adoption-tips-item">
            Include high-quality photos of your pet from different angles and in
            different settings to showcase their personality.
          </li>
          <li class="adoption-tips-item">
          ...
          <li class="adoption-tips-item">
            Be honest about any challenges or issues your pet may have, such as
            separation anxiety or a history of aggression, but also highlight
            their positive qualities and unique traits.
          </li>
          <li class="adoption-tips-item">
            Describe how your pet interacts with other animals, including
            whether they get along with other pets or prefer to be the only pet
            in the household.
          </li>
          <li class="adoption-tips-item">
            Consider creating a video of your pet to showcase their personality
            and help potential adopters get a better sense of their energy level
            and temperament.
          </li>
          <li class="adoption-tips-item">
          ...
          <li class="adoption-tips-item">
            Ask potential adopters about their lifestyle and living situation to
            ensure that your pet will be a good fit for their home and family.
          </li>
          <li class="adoption-tips-item">
