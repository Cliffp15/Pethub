  ...
  return (
    <div className="shelter-card">
      <div className="sheltername">
        {" "}
        <strong>{shelterinfo.name}</strong>
      </div>
     
      {/* <br /> */}
      <div className="shelterdistance"> Distance: {shelterinfo.distance}</div>
      {/* <div className="shelteraddress"> Address: {address}</div> */}
      {shelterinfo.phone !== null && (
      
      <div className="shelterphone">
        ...
        >
         ...
         {" "}
         Phone: <a href={`tel:${shelterinfo.phone}`}>{shelterinfo.phone}</a>
      </div>
